...
def handle_response(message) -> str:
    ...
    if p_message == 'ciao' or p_message == 'salve' or p_message == 'buonasera' or p_message == 'we' or p_message == 'hey':
        greetings = np.array(["Ciao 👋", "Ehilà fattone!", "Hai già rollata il tuo joint prima di scrivere?", "Ciao ❤️", "01101001 ... Whoops scusate... "
                                                                         "Ciao!", "Perché la marijuana è illegale? Cresce naturalmente sul nostro pianeta. L'idea di rendere la natura illegale non vi sembra un po'... innaturale?"])
    ...
    if p_message == '!quote':
        quotes = np.array(["`“Perché bere e guidare quando puoi fumare e volare?”\r\r- Bob Marley`", "`“L'erba è come la frutta. Ti mantiene in forma e ti libera la mente.”\r\r- Bob Marley`", "`“Meno Gesù più Maria.”`", "`“L'erba cattiva non muore mai, l'erba buona finisce subito.”`"])
